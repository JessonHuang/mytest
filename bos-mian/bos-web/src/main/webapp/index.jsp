	...
	*/
	function clickTree(event,treeId,treeNode){
		...
		if( $("#tabs").tabs("exists",name)  ){
			...
			/*
			 content:加载html标签内容
			 href: 使用另一个页面作为面板内容。注意：href只会加载页面的body以内的内容
			*/
			...
			$("#tabs").tabs("add",{
				...
				title:name,
				//内容
				content:"<iframe src='"+pageUrl+"' style='width: 100%;height: 400px;' frameborder='0'></iframe>",
				//关闭按钮
				closable:true
			});
		}
	...
	function showAbout() {
		$.messager.alert("bos v2.0综合物流管理平台",
				"设计: 传智播客<br/> 管理员邮箱: itcast_search@163.com <br/>");
	}
</script>
</head>
	...
	<div data-options="region:'center'">
		<div id="tabs" fit="true" class="easyui-tabs" border="false">
			<div title="消息中心" id="subWarp"
				...
				<iframe src="message.jsp" style="width: 100%;height:400px; " frameborder="0"></iframe>
			</div>
		</div>
	</div>
